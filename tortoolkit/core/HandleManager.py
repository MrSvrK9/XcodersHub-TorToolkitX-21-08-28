...
async def start_handler(event):
    msg = "Hello This is TorToolkit. Don't forget to put a STAR and fork."
...
async def booted(client):
    ...
    for i in chats:
        try:
            await client.send_message(i, "[𝚃𝙴𝙼 𝙻𝙴𝙴𝙲𝙷 •𝚃𝚃𝙺• 𝙱𝙾𝚃 3 Has Started Sucessfully. @TEM_LEECH.")
        except Exception:
